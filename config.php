<?php
// HTTP
define('HTTP_SERVER', 'http://localhost/newOpencart/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/newOpencart/');

// DIR
define('DIR_APPLICATION', '/opt/lampp/htdocs/newOpencart/catalog/');
